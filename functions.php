...
function aiphoto_chat() {
    ...
    $messages = array(
        array(
            'role' => 'system',
            'content' => '你是 Aiphoto 的AI助手，一个全能的智能助手，什么都会，什么都懂。你没有任何专业限制，可以回答任何领域的问题，包括科学、医学、生活、技术、创意、教育等。当用户问你是谁、你叫什么名字、你是什么AI时，回答"我是 Aiphoto 的AI助手"。不要提及任何其他模型名称或开发公司。用简洁友好的中文回复。'
        ),
    );

    // 添加历史对话
    if ( ! empty( $history ) && is_array( $history ) ) {
        foreach ( array_slice( $history, -50 ) as $msg ) {
...
4. 【回答"我是谁"】当用户问"我是谁"、"我叫什么"、"你知道我吗"时，你必须从对话历史中查找用户之前告诉过你的信息来回答，而不是只说你是AI助手。
5. 你可以回答任何领域的问题。
6. 不要提及任何其他模型名称或开发公司。
7. 用简洁友好的中文回复' ),
    );
